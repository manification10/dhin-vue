      ...
      <div class="md-layout">
        <div class="md-layout-item">
          <div class="image-wrapper">
            <!-- <img :src="dance" alt="leaf4" class="leaf4" v-show="leafShow" />
            <img :src="dance" alt="leaf3" class="leaf3" v-show="leafShow" />
            <img :src="dance" alt="leaf2" class="leaf2" v-show="leafShow" />
            <img :src="dance" alt="leaf1" class="leaf1" v-show="leafShow" /> -->
            <div class="brand">
              <!-- MEERA -->
              <h1>Dhin</h1>
...
export default {
  ...
  props: {
    image: {
      type: String,
      default: require("@/assets/img/dance.jpg")
    },
    leaf4: {
      type: String,
    ...
    alana: {
      type: String,
      default: require("@/assets/img/alana.jpg")
    },
    anisha: {
      type: String,
      default: require("@/assets/img/anisha.jpg")
    },
    anu: {
      type: String,
      default: require("@/assets/img/anu.jpg")
    },
    anjana: {
      type: String,
      default: require("@/assets/img/anjana.jpg")
    },
    meera: {
      type: String,
      default: require("@/assets/img/meera.jpg")
    },
    nikhita: {
      type: String,
      default: require("@/assets/img/nikhita.jpg")
    },
  },
  data() {
    return {
